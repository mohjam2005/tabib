...
<!-- Blog Post -->
  ...
  <div class="card-body">
            ...
            <p class="card-text"><h3> المريض يعاني من  : </h3><?php echo e($states1->title); ?> </p>
            </div>
            <div class="alert alert-warning" role="alert">
                        <p class="card-text"><h3> الوقاية  : </h3><?php echo e($states1->protection); ?> </p>
                       </div>
            <div class="alert alert-info" role="alert">

            <p class="card-text"><h3>العلاج : </h3><?php echo e($states1->treatment); ?> </p>
           </div>         
          </div>
...
<form method="POST" action="store3" style="text-align: right;"  enctype="multipart/form-data">
    ...
    <input type="hidden" class="form-control" name="disease_id" id="disease_id" value="<?php echo e($states1->id); ?>" >
